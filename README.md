...
## 🔹 SECTION 1: NAVBAR
### 1. Screenshot
<img width="844" height="375" alt="navbar png1" src="[https://github.com/user-attachments/assets/89f6807a-db2a-4902-9f85-698e6605fed9](https://github.com/user-attachments/assets/89f6807a-db2a-4902-9f85-698e6605fed9)" />
...
### 1. Screenshot
<img width="546" height="346" alt="Screenshot 2026-06-06 132118" src="[https://github.com/user-attachments/assets/0ed63801-85bb-43ad-a334-d949ee50d490](https://github.com/user-attachments/assets/0ed63801-85bb-43ad-a334-d949ee50d490)" />
### 2. Box Tree - Parent Child Hierarchy | HTML Tags
| Box Name | HTML Tag | Description |
|---|---|---|
...
## 🔹 SECTION 3: ABOUT US
### 1. Screenshot
<img width="553" height="320" alt="Screenshot 2026-06-06 132225" src="[https://github.com/user-attachments/assets/35110a85-42f5-427f-8d40-dd4e260f3a5f](https://github.com/user-attachments/assets/35110a85-42f5-427f-8d40-dd4e260f3a5f)" />
### 2. Box Tree - Parent Child Hierarchy | HTML Tags
| Box Name | HTML Tag | Description |
|---|---|---|
...
### 1. Screenshot
<img width="670" height="321" alt="Screenshot 2026-06-06 132448" src="[https://github.com/user-attachments/assets/d1efafbf-40b8-4269-a34d-e7b793298717](https://github.com/user-attachments/assets/d1efafbf-40b8-4269-a34d-e7b793298717)" />
### 2. Box Tree - Parent Child Hierarchy | HTML Tags
| Box Name | HTML Tag | Description |
|---|---|---|
...
### 1. Screenshot
<img width="699" height="291" alt="Screenshot 2026-06-06 132928" src="[https://github.com/user-attachments/assets/4e85b7ff-0053-4612-80a1-70bd7cc565a4](https://github.com/user-attachments/assets/4e85b7ff-0053-4612-80a1-70bd7cc565a4)" />
### 2. Box Tree - Parent Child Hierarchy | HTML Tags
| Box Name | HTML Tag | Description |
|---|---|---|
| FEATURES CONTAINER | <section> | Outermost section for features. |
| LEFT TITLE BOX | <div> | Left column for the heading. |
| RIGHT GRID BOX | <div> | Right column containing grid items. |
| **FEATURE CARD** | <div> | Individual feature (Sale, Delivery, Stores, Warranty). |
### 3. CSS Properties Table
| Property | Value | Purpose |
|---|---|---|
| display | grid | Creates structured grid layout. |
| grid-template-columns | 1fr 1fr | Creates two equal columns for cards. |
## 🔹 SECTION 6: OUR PRODUCTS
### 1. Screenshot
<img width="397" height="370" alt="Screenshot 2026-06-06 133047" src="[https://github.com/user-attachments/assets/6f2a5dd0-753e-469d-a95d-afbd377115d5](https://github.com/user-attachments/assets/6f2a5dd0-753e-469d-a95d-afbd377115d5)" />
### 2. Box Tree - Parent Child Hierarchy | HTML Tags
| Box Name | HTML Tag | Description |
|---|---|---|
...
### 1. Screenshot
<img width="748" height="355" alt="Screenshot 2026-06-06 133129" src="[https://github.com/user-attachments/assets/8fde53da-90e3-4963-8d47-17ed54728c3c](https://github.com/user-attachments/assets/8fde53da-90e3-4963-8d47-17ed54728c3c)" />
### 2. Box Tree - Parent Child Hierarchy | HTML Tags
| Box Name | HTML Tag | Description |
|---|---|---|
...
Ab ismein Section 5 ke card elements bhi shamil hain aur structure bilkul clear hai. Kya aapko kisi aur section mein koi tabdili (change) chahiye?
